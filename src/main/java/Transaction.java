...
public class Transaction {
    ...
    public boolean processTransaction() {
        ...
        for(TransactionInput i : inputs) {
            i.UTXO = NguyenVanThao_Chain.UTXOs.get(i.transactionOutputId);
        }

        //Kiểm tra giao dịch hợp lệ
        if(getInputsValue() < NguyenVanThao_Chain.minimumTransaction) {
            System.out.println("Đầu vào của giao dịch quá bé: " + getInputsValue());
            System.out.println("Vui lòng nhập số tiền giao dịch lớn hơn " + NguyenVanThao_Chain.minimumTransaction);
            return false;
        }
        ...
        for(TransactionOutput o : outputs) {
            NguyenVanThao_Chain.UTXOs.put(o.id , o);
        }
        ...
        for(TransactionInput i : inputs) {
            ...
            NguyenVanThao_Chain.UTXOs.remove(i.UTXO.id);
        }
